...
public class SuiteVisionCase2_MFS extends SuiteVisionBase{
	...
	@Test(dataProvider="SuiteVisionCase2_MFSData")
	public void SuiteVisionCase2_MFSTest(String DataURL, String DataBrowser, String DataUsername, String DataPassword, String DataSSN, String mostRecentStatement) throws InterruptedException, IOException, UnsupportedFlavorException{
		...
		accessSSNPage("M", "MFS INVESTMENT MANAGEMENT", DataSSN);
		...
		}else
		{
			...
			String selectedOption = new Select(driver.findElement(By.id("idx"))).getFirstSelectedOption().getText();
	...
	@DataProvider
	public Object[][] SuiteVisionCase2_MFSData(){
