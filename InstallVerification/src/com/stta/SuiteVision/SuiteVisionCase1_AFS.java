...
public class SuiteVisionCase1_AFS extends SuiteVisionBase{
	...
	@Test(dataProvider="SuiteVisionCase1_AFSData")
	public void SuiteVisionCase1_AFSTest(String DataURL, String DataBrowser, String DataUsername, String DataPassword, String DataSSN) throws InterruptedException, IOException, UnsupportedFlavorException{
		...
		accessSSNPage("A", "AMERICAN FUNDS", DataSSN);
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("html/body/table[2]/tbody/tr/td[2]/table[2]/tbody/tr/td/table/tbody/tr[7]/td[1]/input[1]")));
		driver.findElement(By.xpath("html/body/table[2]/tbody/tr/td[2]/table[2]/tbody/tr/td/table/tbody/tr[7]/td[1]/input[1]")).click();
		Add_Log.info("Clicked 'Go' button next to Acct Details");
		
		// Click 'Stmnts/Tax Forms on the left navigation bar
		wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Stmnts / Tax Forms")));
		driver.findElement(By.linkText("Stmnts / Tax Forms")).click();
		Add_Log.info("Clicked 'Stmnts/Tax Forms on the left navigation bar");
				
		//The most recent statement will be display. Click the dropdown at the top of the screen to display older thank 2006 statements
		...
		dropdownDoc.selectByVisibleText("Quarterly Statement 12/30/2005");
		...
		Add_Log.info("Clicked the dropdown at the top of the screen to display older statements");
	...
	@DataProvider
	public Object[][] SuiteVisionCase1_AFSData(){
