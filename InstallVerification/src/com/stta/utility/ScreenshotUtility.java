...
public class ScreenshotUtility implements ITestListener{	
	...
	{
		this.dateTime = SuiteBase.dateFolderNameFinal;
	}
	...
	public void captureScreenShot(ITestResult result, String status){	
    	...
    	//========================================================================================================================
    	// 29 Nov Custom report + screenshot file path
    	if(status.equalsIgnoreCase("fail")){
    		destDir = "C:\\InstallVerificationReports"+ "\\" + dateTime  + "\\screenshots\\Failures";
    	}
    	//If status = pass then set folder name "screenshots/Success"
    	else if (status.equalsIgnoreCase("pass")){
    		destDir = "C:\\InstallVerificationReports"+ "\\" + dateTime + "\\screenshots\\Success";
    	}
        ...
        // Display screenshot on Reporter Output
        String fileName = destDir + "\\" + destFile;
        Reporter.log("<br><a href=\""+ fileName +"\" target=\"_blank\"><font color = red>Fail. See final screenshot</font></a><br>");
        //============================================================================================================================
