...
public class SuiteUtility {	
	...
	//To write result In test data ROW and test case list sheet.
	public static boolean WriteResultUtilityRow(Read_XLS xls, String sheetName, String ColName, int rowNum, String[] testActualRows, String[] testResultRows){			
		return xls.writeResultRow(sheetName, ColName, rowNum, testActualRows, testResultRows);		 	
	}
