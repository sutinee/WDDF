...
public class SuiteCSRCase3_nTelos extends SuiteCSRBase{
	...
	@Test(dataProvider="SuiteCSRCase3_nTelosData")
	public void SuiteCSRCase3_nTelosTest(String DataURL, String DataBrowser, String DataUsername, String DataPassword, String DataEmulateUser, String DataGroup, String DataDocType, String DataAccountNumber, String DataCorpNumber, String DataBeginDate) throws InterruptedException, IOException, UnsupportedFlavorException{
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.id("corpNumber")));
		driver.findElement(By.id("corpNumber")).sendKeys(DataCorpNumber);
		...
		if(driver.findElement(By.xpath(".//*[@id='theBody']/tr[1]/td[4]/div")).getText().contains("105586280"))
		{
			Add_Log.info("Tested Col 'ACCOUNT#' is correct, containing '105586280'");
		} else {
			s_assert.assertTrue(driver.findElement(By.xpath(".//*[@id='theBody']/tr[1]/td[4]/div")).getText().contains("105586280"), "FAIL: Test Result Col 'ACCOUNT#' does not contain '105586280'");
			Add_Log.info("FAIL: Test Result Col 'ACCOUNT#' does not contain '105586280'");
			Testfail = true;
		}
		//-------------------------------------------------------------------------------------------------------------------------------------------------------
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='theBody']/tr[1]/td[5]/div")));
		if(driver.findElement(By.xpath(".//*[@id='theBody']/tr[1]/td[5]/div")).getText().contains("SCOTT ABSHIRE"))
		{
			Add_Log.info("Tested Col 'ACCOUNT NAME#' is correct, containing 'SCOTT ABSHIRE'");
		} else {
			s_assert.assertTrue(driver.findElement(By.xpath(".//*[@id='theBody']/tr[1]/td[5]/div")).getText().contains("SCOTT ABSHIRE"), "FAIL: Test Result Col 'ACCOUNT NAME#' does not contain 'SCOTT ABSHIRE'");
			Add_Log.info("FAIL: Test Result Col 'ACCOUNT NAME#' does not contain 'SCOTT ABSHIRE'");
			Testfail = true;
		}
		//-------------------------------------------------------------------------------------------------------------------------------------------------------
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='theBody']/tr[1]/td[6]/div")));
		if(driver.findElement(By.xpath(".//*[@id='theBody']/tr[1]/td[6]/div")).getText().contains("91051"))
		{
			Add_Log.info("Tested Col 'CORP#' is correct, containing '91051'");
		} else {
			s_assert.assertTrue(driver.findElement(By.xpath(".//*[@id='theBody']/tr[1]/td[6]/div")).getText().contains("91051"), "FAIL: Test Result Col 'CORP#' does not contain '91051'");
			Add_Log.info("FAIL: Test Result Col 'CORP#' does not contain '91051'");
			Testfail = true;
		}		
	...
	@DataProvider
	public Object[][] SuiteCSRCase3_nTelosData(){
