...
public class SuiteCSRCase4_Toyota extends SuiteCSRBase{
	...
	@Test(dataProvider="SuiteCSRCase4_ToyotaData")
	public void SuiteCSRCase4_ToyotaTest(String DataURL, String DataBrowser, String DataUsername, String DataPassword, String DataEmulateUser, String DataGroup, String DataDocType, String DataAccountNumber, String DataBeginDate) throws InterruptedException, IOException{
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='theBody']/tr[1]/td[3]/div")));
		if(driver.findElement(By.xpath(".//*[@id='theBody']/tr[1]/td[3]/div")).getText().equals("030612CU935"))
		{
			Add_Log.info("Tested Col 'ACCOUNT#' is correct: '030612CU935'");
		} else {
			s_assert.assertEquals(driver.findElement(By.xpath(".//*[@id='theBody']/tr[1]/td[3]/div")).getText(), "030612Account", "Test Result Col 'ACCOUNT#' is not as expected");
			Add_Log.info("FAIL: Test Result Col 'ACCOUNT#' is not as expected");
			Testfail = true;
		}
		//-------------------------------------------------------------------------------------------------------------
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='theBody']/tr[1]/td[4]/div")));
		if(driver.findElement(By.xpath(".//*[@id='theBody']/tr[1]/td[4]/div")).getText().equals("ALAN F SMITH"))
		{
			Add_Log.info("Tested Col 'ACCOUNT NAME' is correct: 'ALAN F SMITH'");
		} else {
			s_assert.assertEquals(driver.findElement(By.xpath(".//*[@id='theBody']/tr[1]/td[4]/div")).getText(), "ALAN F SMITH", "Test Result Col 'ACCOUNT NAME' is not as expected");
			Add_Log.info("FAIL: Test Result Col 'ACCOUNT NAME' is not as expected");
			Testfail = true;
		}
	...
	@DataProvider
	public Object[][] SuiteCSRCase4_ToyotaData(){
