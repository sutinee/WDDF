...
public class SuiteECCCase7_Neuberger extends SuiteECCBase{
	...
	@Test(dataProvider="SuiteECCCase7_NeubergerData")
	public void SuiteECCCase7_NeubergerDataTest(String DataURL, String DataBrowser, String DataUsername, String DataPassword, String DataSSN, String DataBeginDate) throws InterruptedException, IOException{
		...
		// Select Menu Statements (2007 to present). Using by xpath intead of be name, because there're elements using the same name
		WebDriverWait wait = new WebDriverWait(driver, timeOutSet);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("html/body/center/table[2]/tbody/tr/td/table/tbody/tr[1]/td/input[9]")));
		driver.findElement(By.xpath("html/body/center/table[2]/tbody/tr/td/table/tbody/tr[1]/td/input[9]")).click();
		Add_Log.info("Selected Statement (2007 to present)");
		...
		wait.until(ExpectedConditions.textToBePresentInElementLocated((By.xpath("html/body")),"Neuberger (Templates)"));
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("html/body/center/form/table[1]/tbody/tr[3]/td/table/tbody/tr[2]/td/input")));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("html/body/center/form/table[1]/tbody/tr[3]/td/table/tbody/tr[2]/td/input")));
		driver.findElement(By.xpath("html/body/center/form/table[1]/tbody/tr[3]/td/table/tbody/tr[2]/td/input")).click();
		...
		// Get all search result. Verify one of the statement is presented. i.e. June 30, 2016 Statement
		...
		// Click any statement e.g 4th statement
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("html/body/center/table[2]/tbody/tr/td/table/tbody/tr[7]/td/a/font")));
		driver.findElement(By.xpath("html/body/center/table[2]/tbody/tr/td/table/tbody/tr[7]/td/a/font")).click();
		try {
		...
		if(currentURL.contains(".onlinefinancialdocs")) // current URL on Chrome and FF are the same.
		{
			    ...
			    {
			    	Add_Log.info("PDF content does not contain expected wording Account Number: Statement");
			    	Testfail = true;
			    	s_assert.assertTrue(PDFContent.contains("Statement"), "PDF content does not contain expected wording Account Number: Statement");
	...
	@DataProvider
	public Object[][] SuiteECCCase7_NeubergerData(){
