...
public class SuiteECCCase12_ACI extends SuiteECCBase{
	...
	@Test(dataProvider="SuiteECCCase12_ACIData")
	public void SuiteECCCase12_ACISDataTest(String DataURL, String DataBrowser, String DataUsername, String DataPassword, String DataSSN, String DataBeginDate) throws InterruptedException, IOException{
		...
		Add_Log.info("Selected Statements again");
		
		// Select View Statements
		wait.until(ExpectedConditions.elementToBeClickable(By.name("ViewStmtImage")));
		driver.findElement(By.name("ViewStmtImage")).click();
		...
		wait.until(ExpectedConditions.titleContains("eCC System - Investor Statement Selection"));
		wait.until(ExpectedConditions.textToBePresentInElement(driver.findElement(By.xpath("html/body/form[1]/center/table[2]/tbody/tr/td/table/tbody/tr[1]/td[2]/b/font")), "Click on Date to View the Statement:"));
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("html/body/form[1]/center/table[2]/tbody/tr/td")));
		// Get all search result. Verify one of the statement is presented.
		String statementList = driver.findElement(By.xpath("html/body/form[1]/center/table[2]/tbody/tr/td")).getText();
		if(!statementList.contains("PDF"))
		{
			s_assert.assertTrue(statementList.contains("PDF"), "Tested statement NOT FOUND");
		...
		// Click any statement e.g. 10th statement
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("html/body/form[1]/center/table[2]/tbody/tr/td/table/tbody/tr[12]/td[2]/font/a")));
		driver.findElement(By.xpath("html/body/form[1]/center/table[2]/tbody/tr/td/table/tbody/tr[12]/td[2]/font/a")).click();	
		try {
			  Thread.sleep(waitFileLoad);
			} catch(InterruptedException ex) {
			  Thread.currentThread().interrupt();
			}
		// Copy to clipboard only works on Chrome
	...
	@DataProvider
	public Object[][] SuiteECCCase12_ACIData(){
