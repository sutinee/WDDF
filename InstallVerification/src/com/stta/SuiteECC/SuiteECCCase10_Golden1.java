...
public class SuiteECCCase10_Golden1 extends SuiteECCBase{
	...
	@Test(dataProvider="SuiteECCCase10_Golden1Data")
	public void SuiteECCCase10_Golden1DataTest(String DataURL, String DataBrowser, String DataUsername, String DataPassword, String DataAccountNumber, String DataBeginDate) throws InterruptedException, IOException{
		...
		// Select Menu Statements (CeVP Version)
		...
		Add_Log.info("Selected Statements (CeVP Version)");
		...
		wait.until(ExpectedConditions.textToBePresentInElementLocated((By.xpath("html/body")),"Golden One eCC Web Site"));
		wait.until(ExpectedConditions.presenceOfElementLocated(By.name("SEARCH_FIELD_1")));
		driver.findElement(By.name("SEARCH_FIELD_1")).sendKeys(DataAccountNumber);
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("html/body/center/table[2]/tbody/tr/td/table/tbody/tr[2]/td")));
		// Get all search result. Verify one of the statement is presented. i.e. June 30, 2016 Statement
		String statementList = driver.findElement(By.xpath("html/body/center/table[2]/tbody/tr/td/table/tbody/tr[2]/td")).getText();
		if(!statementList.contains("201")) //any statement. year 201x
		{
			s_assert.assertTrue(statementList.contains("201"), "Statement List NOT FOUND");
			Add_Log.info("Statement List NOT FOUND");
        	Testfail = true;
		}
		else
		{
		...
		// Click any statement e.g. 7th statement
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("html/body/center/table[2]/tbody/tr/td/table/tbody/tr[2]/td/font/a[13]")));
		driver.findElement(By.xpath("html/body/center/table[2]/tbody/tr/td/table/tbody/tr[2]/td/font/a[13]")).click();
		try {
		...
		//driver.get(DataURL); // This case needs this line to activate back the browser window.
	...
	@DataProvider
	public Object[][] SuiteECCCase10_Golden1Data(){
