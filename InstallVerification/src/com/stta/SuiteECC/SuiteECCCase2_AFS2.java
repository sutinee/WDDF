...
public class SuiteECCCase2_AFS2 extends SuiteECCBase{
	...
	@Test(dataProvider="SuiteECCCase2_AFS2Data")
	public void SuiteECCCase2_AFS2DataTest(String DataURL, String DataBrowser, String DataUsername, String DataPassword, String DataSSN, String DataBeginDate, String DataEndDate) throws InterruptedException, IOException{
		...
		// Select "View Statements" from the 'PDF FEATURES"
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("html/body/center/table[2]/tbody/tr/td/table/tbody/tr[8]/td/input[8]")));
		driver.findElement(By.xpath("html/body/center/table[2]/tbody/tr/td/table/tbody/tr[8]/td/input[8]")).click();
		Add_Log.info("Selected 'View Statements' from the 'PDF FEATURES'");
		
		// Enter Search Criteria and View Document
		wait.until(ExpectedConditions.textToBePresentInElementLocated((By.xpath("html/body")),"Prod - OTP (Database)"));
		...
		// Get all search result. Verify one of the statement is presented. i.e. December 31, 2004 Statement AF3	Dealer (1st December 31, 2004)
		...
		// Click any statement e.g. 3rd statement
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("html/body/center/table[2]/tbody/tr/td/table/tbody/tr[6]/td[1]/a/font")));
		driver.findElement(By.xpath("html/body/center/table[2]/tbody/tr/td/table/tbody/tr[6]/td[1]/a/font")).click();
		try {
	...
	@DataProvider
	public Object[][] SuiteECCCase2_AFS2Data(){
