...
public class SuiteECCCase13_MFS extends SuiteECCBase{
	...
	@Test(dataProvider="SuiteECCCase13_MFSData")
	public void SuiteECCCase13_MFSSDataTest(String DataURL, String DataBrowser, String DataUsername, String DataPassword, String DataSSN, String DataBeginDate) throws InterruptedException, IOException{
		...
		// Select Statements. Using by xpath instead of by name, because of duplicated name elements
		...
		if(currentURL.contains(".onlinefinancialdocs")) // current URL on Chrome and FF are the same.
		{
			    ...
			    if(PDFContent.contains("Summary"))
			    {
			    ...
			    else
			    {
			    	...
			    	Testfail = true;
			    	s_assert.assertTrue(PDFContent.contains("Summary"), "PDF content does not contain expected wording: Summary");
			    	fileName1_statement = takeScreenshot(TestCaseName, "1_ViewStatementFail");
			    }*/
				String PDFContent = "";
				String expectedWording = "Summary";
	...
	@DataProvider
	public Object[][] SuiteECCCase13_MFSData(){
