...
public class SuiteECCCase8_Neuberger2 extends SuiteECCBase{
	...
	@Test(dataProvider="SuiteECCCase8_Neuberger2Data")
	public void SuiteECCCase8_Neuberger2DataTest(String DataURL, String DataBrowser, String DataUsername, String DataPassword, String DataSSN, String DataBeginDate, String DataEndDate) throws InterruptedException, IOException{
		...
		// Select Menu Statements (2007 to older)
		WebDriverWait wait = new WebDriverWait(driver, timeOutSet);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("html/body/center/table[2]/tbody/tr/td/table/tbody/tr[2]/td/input[9]")));
		driver.findElement(By.xpath("html/body/center/table[2]/tbody/tr/td/table/tbody/tr[2]/td/input[9]")).click();
		Add_Log.info("Selected Statement (2007 to older)");
		...
		// Get all search result. Verify one of the statement is presented. i.e. December 29, 2000 Statement
		...
		// Click any statement e.g. 1st statement
	...
	@DataProvider
	public Object[][] SuiteECCCase8_Neuberger2Data(){
