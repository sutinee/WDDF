...
public class SuiteECCCase15_Columbia extends SuiteECCBase{
	...
	@Test(dataProvider="SuiteECCCase15_ColumbiaData")
	public void SuiteECCCase15_ColumbiaSDataTest(String DataURL, String DataBrowser, String DataUsername, String DataPassword, String DataSSN, String DataBeginDate) throws InterruptedException, IOException{
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("html/body/center/table[3]/tbody/tr/td/table/tbody/tr[6]/td/a/img")));
		driver.findElement(By.xpath("html/body/center/table[3]/tbody/tr/td/table/tbody/tr[6]/td/a/img")).click();
		...
		wait.until(ExpectedConditions.presenceOfElementLocated((By.id("SEARCH_FIELD_0"))));
		driver.findElement(By.name("SEARCH_FIELD_0")).sendKeys(DataSSN);
		...
		// Do not select radial button as "Enabled Only". Updated 28 Nov 2016 from click "enabled only" to do not click.
		//wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("html/body/center/form/table[1]/tbody/tr[7]/td/input[2]")));
		//driver.findElement(By.xpath("html/body/center/form/table[1]/tbody/tr[7]/td/input[2]")).click();
		Add_Log.info("SSN Entered.");
		...
		String statementList = driver.findElement(By.xpath("html/body/center")).getText();
		if(!statementList.contains("Click on date to View the Document"))
		{
			s_assert.assertTrue(statementList.contains("Click on date to View the Document"), "Tested statement NOT FOUND.");
	...
	@DataProvider
	public Object[][] SuiteECCCase15_ColumbiaData(){
